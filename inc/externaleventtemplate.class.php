 ...
 * @since 9.5
**/
class PluginPlanningExternalEventTemplate extends CommonDropdown {
   ...
   function displaySpecificTypeField($ID, $field = []) {
      ...
      switch ($field['type']) {
         case 'planningstate' :
            PluginPlanningPlanning::dropdownState("state", $this->fields["state"]);
            break;
   ...
   static function getSpecificValueToDisplay($field, $values, array $options = []) {
      ...
      switch ($field) {
         case 'state':
            return PluginPlanningPlanning::getState($values[$field]);
      }
   ...
   static function getSpecificValueToSelect($field, $name = '', $values = '', array $options = []) {
      ...
      switch ($field) {
         case 'state':
            return PluginPlanningPlanning::dropdownState($name, $values[$field], $options);
      }
